  ...
  return (
    <ScreenWrapper>
      ...
      <Card variant="primary">
        <Heading>Primary Card</Heading>
        <Body>Used for the main content surfaces in the app.</Body>
      </Card>
      <Card variant="secondary">
        <Heading>Secondary Card</Heading>
        <Body>Slightly darker — used for nested or supporting content.</Body>
      </Card>
      <Card variant="primary">
        <Heading>Nested Example</Heading>
        <Body>A primary card can contain a secondary card inside it.</Body>
        <Card
          variant="secondary"
